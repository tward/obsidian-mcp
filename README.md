...
> **This is a maintained fork of [natestrong/obsidian-mcp](https://github.com/natestrong/obsidian-mcp) (via [TheStrong1/obsidian-mcp](https://github.com/TheStrong1/obsidian-mcp)).** The original repo was deleted. This fork brings the codebase to v2.1.6 parity and fixes a breaking `fastmcp` import issue (`from fastmcp import Image` was removed in fastmcp v2.14.0).
